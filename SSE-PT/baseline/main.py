...
for epoch in range(1, args.num_epochs + 1):
    ...
    for step in tqdm(range(num_batch), total=num_batch, ncols=70, leave=False, unit='b'):
        ...
        auc, loss, item_emb_table, _ = sess.run([model.auc, model.loss, model.item_emb_table, model.train_op],
    ...
    if epoch % 20 == 0:
        ...
        #print("[{0}, {1}, {2}, {3}, {4}, {5}, {6}],".format(epoch, T, t_valid[0], t_valid[1], t_test[0], t_test[1], calc_dist(item_emb_table)))
