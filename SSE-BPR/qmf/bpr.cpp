...
DEFINE_double(user_threshold, 1.0, "(1 - user_threshold) to change sgd user idx");
DEFINE_double(item_threshold, 1.0, "(1 - item_threshold) to change sgd item idx");
...
int main(int argc, char** argv) {
  ...
  qmf::BPRConfig config{FLAGS_nepochs,
                        ...
                        FLAGS_user_threshold,
                        FLAGS_item_threshold
  };
